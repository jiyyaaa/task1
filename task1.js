...
response.then((v)=>{
    ...
    for(item in v){
        ...
        <div class="circle" id="circle4">2</div>
        <div class="circle" id="circle6" >3</div>
        <div class="circle" id="circle1" ><img src="${v[1].avatar}"></img></div>
        <div id="circle2"><img src="${v[0].avatar}"></img></div>
        <div class="circle" id="circle3" ><img src="${v[2].avatar}"></img></div>
        <div class="circle" id="ellipse1">${v[1].name}
        <div class="circle2 c1"></div>
        ${v[1].points}
        </div>
        <div id="ellipse2">${v[0].name}
        <div class="circle2 c2"></div>
        ${v[0].points}
        </div>
        <div class="circle" id="ellipse3">${v[2].name}
        <div class="circle2 c1"></div>
        ${v[2].points}
        </div>
